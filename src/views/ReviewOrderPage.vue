        ...
        <div class="container mx-auto bg-[#f9f5f6] mt-10">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p id="billing-name" class="mt-2 text-lg text-gray-700 nunito-sans-dark">
                                    {{ billingAddress ? `${billingAddress.first_name} ${billingAddress.last_name}` :
                                        'Loading...' }}
                                </p>
                                <div class="text-gray-700 text-md nunito-sans-light">
                ...
                <div class="flex flex-col">
                    ...
                    <div>
                        <div id="card-element"><!-- Stripe Card Element will render here --></div>
...
export default {
    ...
    data() {
        return {
            stripe: null,
            card: null,
            publishableKey: 'pk_test_51QRW37Bl2yY8FU6UKeAbQGJ9thPYl4bG1R2Lw9CYmVoSuT6JXH1JYSIfEmDP96hCiN2NrklHKbNSOgRbZS6zpeem00yVYxgk2Y',
        };
    },
